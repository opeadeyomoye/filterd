...
<div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-md w-full space-y-8" style="min-height: 75vh">
    <div>
      <?= '' // $this->Html->image('mark.png', ['class' => 'mx-auto h-12 w-auto', 'alt' => 'filterd'])
      ?>
      ...
      <p class="mt-2 text-center text-sm text-gray-600">
        Or
        <a href="<?= $this->Url->build('/sign-up') ?>" class="font-medium text-teal-600 hover:text-teal-700">
          start your free trial
        </a>
      </p>
    </div>

    <?= $this->Form->create(null, ['method' => 'post', 'class' => 'mt-8 space-y-6']) ?>
